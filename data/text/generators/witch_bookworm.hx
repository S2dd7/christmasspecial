...
var weirdspells = ["Infliction","Knitting Needle","Poison Needle","Antidote",rand(["Nunchucks","Sharp Spike"]),"Wrecking Ball",rand(["Magic Dagger","Push Knife"]),"Magic Dagger",rand(["Hex","Nightstick"]),rand(["Ignite","Cold Wind"]),"Icicle","Lighter","Hex","Cowbell",rand(["Capacitor","Blast Chiller","Furnace"]),"Slime Ball","Slime Ball",rand(["Matchstick","Ghost Pepper"]),"Ghost Pepper",rand(["Icecube","Snowflake"]),"Snowflake","Spark","Whisper","Blood Let","Catastrophe","Fiasco",rand(["Determination","Secret Weapon"]),"Spring Equinox","Overwinter"];
...
var counterspelllikes = ["Counter Spell","Counter Spell","Parrying Dagger"];
